...
def estilos_globales():
    ...
    <div class="footer-credits">
        <div style="font-weight: bold; color: #002F6C; font-size: 11px;">
            Hecho por: Quiros Daniel, Alquinga Cristopher, Narváez Milisen, Tenorio Kevin, Argoti Marlon.
        </div>
...
def interfaz_gestor_archivos():
    ...
    with col_contenido:
        st.info("Ayuda al Ing. Dante a aprender subiendo los sílabos y libros aquí.") 
        st.markdown("---") 
